...
def db_login(username, password)
	id = ""
	@con1 = Mysql2::Client.new(:host => "127.0.0.1", :username => "<USERNAME>", :database => "<DATABASE>", :password => "<PASSWORD>")
...
def db_get(id)
	@con = Mysql2::Client.new(:host => "127.0.0.1", :username => "<USERNAME>", :database => "<DATABASE>", :password => "<PASSWORD>")
...
def db_get_flag()
	@con = Mysql2::Client.new(:host => "127.0.0.1", :username => "<USERNAME>", :database => "<USERNAME>", :password => "<PASSWORD>")
